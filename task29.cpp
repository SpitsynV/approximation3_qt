...
//Триангуляция строится по блокам - разбиваем область на 4 прямоугольника, в них определяем прямоугольные ячейки, каждую делим диагональю на 2 прямоугольных треугольника
