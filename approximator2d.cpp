...
Approximator2D::Approximator2D(double a, double b, double c, double d, double aa, double bb, double cc, double dd,
                               int nx, int ny, int mx, int my, int k)
    : m_a(a), m_b(b), m_c(c), m_d(d), m_aa(aa), m_bb(bb), m_cc(cc), m_dd(dd)
